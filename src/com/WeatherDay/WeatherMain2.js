...
let lis = w2.map((m)=>
  (m.category === 'PTY')
  ? <li className='li2' key={m.category}>{item[m.category][0]} {PTY[m.obsrValue]}</li>
  :(m.category==='SKY')
  ? <li className='li2' key={m.category}>{item[m.category][0]} {SKY[m.obsrValue]}</li>
  : <li className='li2' key={m.category}>{item[m.category][0]} {m.obsrValue}{item[m.category][1]}</li>
